...
AUDIO_DIR = ROOT_DIR / "processed_audio" / "audio_5700_train_dev_16k"
TEXT_JSON = ROOT_DIR / "raw_data" / "text_5700_train_dev" / "data.json"
OUTPUT_MANIFEST = ROOT_DIR / "processed_data" / "root_train_dev_manifest_NeMo.json"
SEGMENTS_DIR = ROOT_DIR / "processed_audio" / "audio_5700_train_dev_16k_segments"
...
# Total: 167386 samples in the manifest
# remove unknown intent sample
# remaining 154743 samples